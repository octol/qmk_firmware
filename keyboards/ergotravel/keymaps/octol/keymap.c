...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
     LCTL_ESC,KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    _______,          _______, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, RCTL_QUOT,
  //|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
  ...
  KC_ESC,  KC_LCBR,  KC_RCBR, KC_LPRN, KC_RPRN, KC_PIPE, _______,          _______,     KC_PLUS, KC_MINS, KC_UNDS, KC_EQL,  _______, PREV_TAB, \
  ...
  _______, KC_LGUI, KC_LALT,KC_LCTL,KC_LSFT, PREV_TAB, _______,          _______,   KC_LEFT,   KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
  ...
  [_ADJUST] = LAYOUT(
     ...
     _______, _______, _______, _______, _______, RESET,   _______,         _______,  _______, _______, _______, KC_F11,  KC_F12,  _______,
