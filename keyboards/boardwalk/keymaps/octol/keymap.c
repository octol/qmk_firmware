...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ortho_hhkb(
        ...
        NUM_TAB, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_HOME, KC_PGUP, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    ...
    [_NUM] = LAYOUT_ortho_hhkb(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        KC_GRV,  SV_AA,   SV_AE,   KC_7,    KC_8,    KC_9,    _______, _______, _______, _______, _______, _______, SV_OE,   KC_INS,
        _______, KC_PLUS, KC_MINS, KC_4,    KC_5,    KC_6,    _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
        _______, KC_ASTR, KC_0,    KC_1,    KC_2,    KC_3,    _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______, _______,
                 _______, _______, _______, _______,          _______, _______,          _______, _______, _______, _______
    ),
    ...
    [_ADJUST] = LAYOUT_ortho_hhkb(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,
                 _______, _______, _______, _______,          _______, _______,          _______, _______, _______, _______
    ),

    [_NUMPAD] = LAYOUT_ortho_hhkb(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_ASTR, KC_7,    KC_8,    KC_9,    KC_MINS,_______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_SLSH, KC_4,    KC_5,    KC_6,    KC_PLUS, _______,
