...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT_ortho_hhkb(
        ...
        _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, RESET,
    ...
    [_ADJUST] = LAYOUT_ortho_hhkb(
        ...
        _______, RGB_TOG, KC_APP,  _______, _______, _______, _______, _______, _______, _______, _______, KC_F11,  KC_F12,  RESET,
