...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
      ...
      FN3_ESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_ENT,
      KC_LSFT, KC_SLSH, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, KC_RSFT,
      KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  MO(2),   MO(1),   KC_RALT, MO(4),   MO(3) ),

  // Symbol layer
  [1] = LAYOUT_all(
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
      _______, KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, KC_PIPE, KC_PLUS, KC_MINS, KC_UNDS, KC_EQL,  _______,
      _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS, KC_SCLN, KC_COLN, KC_QUOT, KC_DQUO, _______,
  ...
  [3] = LAYOUT_all(
      ...
      _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
