...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi(
        ...
        LCTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    LT(1, KC_SCLN),   KC_QUOT, KC_ENT,  KC_PGDN,
    ...
    [1] = LAYOUT_65_ansi(
        ...
        _______,        RGB_SPI, RGB_SPD, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          EEP_RST, KC_PGDN,
