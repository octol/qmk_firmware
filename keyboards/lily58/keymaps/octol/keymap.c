 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_BSPC, KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, KC_PIPE,                   KC_PLUS, KC_MINS, KC_UNDS, KC_EQL,  _______, _______, \
 ...
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------| MLeft| Mdown| MUp  |MRight| End  | PgDn |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |RAISE |      |      |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,  _______, _______,  KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_END, KC_PGDN, \
                             _______, _______, _______,  _______, _______,  _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
