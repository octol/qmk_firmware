...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_RAISE] = LAYOUT_preonic_grid( \
      ...
      _______, _______, KC_PGUP, KC_UP, KC_PGDN, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, _______, \
      _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______, \
	...
	[_ADJUST] = LAYOUT_preonic_grid( \
      ...
      _______, _______, MU_MOD, AU_ON, AU_OFF, AG_NORM, AG_SWAP, DF(0), DF(1), DF(2), _______, _______, \
