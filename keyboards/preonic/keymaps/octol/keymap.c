...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |Shift |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  -   |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | Ctrl | GUI  | Alt  |Shift |Lower |    Space    |Raise |Enter | Alt  | GUI  | Ctrl |
     * `-----------------------------------------------------------------------------------'
     */
	[_QWERTY] = LAYOUT_preonic_grid( \
      ...
      KC_LCTL,        KC_LGUI, KC_LALT, KC_LSFT, MO(1), KC_SPC, KC_SPC, MO(2), KC_ENT,  KC_RALT, KC_RGUI, KC_RCTL
      ),
    /* Lower
     * ,-----------------------------------------------------------------------------------.
     * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Bksp |
	...
	[_RAISE] = LAYOUT_preonic_grid( \
      ...
      _______, _______, _______, KC_ESC,  KC_TAB,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  _______, _______, \
