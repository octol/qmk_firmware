...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | Ctrl |      | Alt  |Shift |Lower |    Space    |Raise | Alt  | Gui  |      | Ctrl |
     * `-----------------------------------------------------------------------------------'
     */
     ...
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * |      |      |      |Aud on|AudOff|AGnorm|AGswap|BL on |BL off|      |      |      |
     * |------+------+------+------+------+------|------+------+------+------+------+------|
	...
	[_ADJUST] = LAYOUT_preonic_grid( \
      ...
      _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, BL_ON,   BL_OFF,   _______, _______, _______, \
